            ...
            <div className='mains-body'>
                <div className='big'>
                    <div className='phone-div'>
                            ...
                            <div className='phonebig-div'>{imagethl("groceries")}</div>
                    </div>
                    ...
                    <div className='phone-divs'>
                            ...
                            <div className='phonebig-div'>{imageApi1("groceries")}</div>
                    </div>
                    <div className='phone-divs'>
                            <div className='upper-div'>
                                    <p>Official Store</p>
                            </div>
                            <div className='phonebig-div'>{imageApi2("groceries")}</div>
                    </div>
                    <div className='phone-divs'>
                            <div className='upper-div'>
                                    <p>Smartphones</p>
                            </div>
                            <div className='phonebig-div'>{imageApi3("groceries")}</div>
                    </div>
                    <div className='phone-divs'>
                            <div className='upper-div'>
                                    <p>Phone Deals</p>
                            </div>
                            <div className='phonebig-div'>{imageApi4("groceries")}</div>
                    </div>
                </div>
            </div>
        </div> 
