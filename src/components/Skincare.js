            ...
            <div className='mains-body'>
                <div className='big'>
                    <div className='phone-div'>
                            ...
                            <div className='phonebig-div'>{imagethl("skincare")}</div>
                    </div>
                    ...
                    <div className='phone-divs'>
                            ...
                            <div className='phonebig-div'>{imageApi1("skincare")}</div>
                    </div>
                    <div className='phone-divs'>
                            <div className='upper-div'>
                                    <p>Official Store</p>
                            </div>
                            <div className='phonebig-div'>{imageApi2("skincare")}</div>
                    </div>
                    <div className='phone-divs'>
                            <div className='upper-div'>
                                    <p>Smartphones</p>
                            </div>
                            <div className='phonebig-div'>{imageApi3("skincare")}</div>
                    </div>
                    <div className='phone-divs'>
                            <div className='upper-div'>
                                    <p>Phone Deals</p>
                            </div>
                            <div className='phonebig-div'>{imageApi4("skincare")}</div>
                    </div>
                </div>
            </div>
        </div> 
